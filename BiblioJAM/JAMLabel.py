...
class JAMLabel(pygame.sprite.Sprite):
    def __init__(self, texto):
        ...
        # Agregado 15-06-2011 - Para cargar un tipo de letra desde un archivo.(os.getcwd()+"/Fuentes/fawn.ttf", 43)
        ...
        self.JAMObjects = {"Imagen": self.imagen,
                           "Texto": self.texto, "Contenedor": self.contenedor}
    ...
    def construye_texto(self):
        ...
        fuente = pygame.font.Font(pygame.font.match_font(
            self.texto["tipo"], True, False), int(self.texto["tamanio"]))
        ...
        self.contenedor["base"]["tamanio"] = (imagen_fuente.get_size(
        )[0]+self.separador*2, imagen_fuente.get_size()[1]+self.separador*2)
    ...
    def concatenar(self, sprite_texto, sprite_imagen):
        ...
        self.contenedor["base"]["tamanio"] = (
            w+w1+self.separador*3, altura+self.separador*2)
