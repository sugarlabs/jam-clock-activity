...
class JAMEntryText(pygame.sprite.OrderedUpdates):
    def __init__(self):
        ...
        self.texto = {"fondo": VG.get_blanco(), "tipo": pygame.font.get_default_font(
        ), "tamanio": 20, "color": VG.get_negro()}
    ...
    def set_buffer(self, texto):
        ...
        if texto != self.buffertext:
            ...
            self.label_buffer.set_text(
                tipo=self.texto["tipo"], tamanio=self.texto["tamanio"], color=self.texto["color"], texto=self.buffertext)
    ...
    def set_posicion(self, punto=(0, 0)):
        ...
        x, y = (self.frame.rect.x + self.separador,
...
class Promp(pygame.sprite.Sprite):
    ...
    def get_promp(self, color):
        ...
        fuente = pygame.font.Font(pygame.font.match_font(
            self.entry.texto["tipo"], True, False), self.entry.texto["tamanio"])
...
class Ejemplo(object):
    ...
    def ejemplo_cambia_colors(self):
        import random
        colores = [(128, 128, 128, 255), (255, 100, 100, 255),
                   (255, 255, 100, 255), (255, 0, 0, 255)]
        color = random.choice(colores)
        self.widgets.set_entry(
            tipo_letra=None, tamanio_letra=None, color_texto=color, color_fondo=None)
        return 0
