...
class JAMDragAndDrop():
    ...
    def update(self):
        ...
        self.rectangulo = pygame.Rect(
            self.objetivo.posicion, self.busca_tamanio())
...
class Ejemplo(object):
    ...
    def setup(self):
        ...
        # JAMDragAndDrop con el grupo que se va a arrastrar.
        self.draganddrop = JAMDragAndDrop(self.calendario)
        # Callback para evento "soltar objetivo".
        self.draganddrop.connect_drop(self.reposiciona)
        # Callback para evento "tomar objetivo".
        self.draganddrop.connect_drag(self.imprime_hola)

        # Lo que se dibuja y actualiza es ahora JAMDragAndDrop
        self.widgets = self.draganddrop
    ...
    def Run(self):
        ...
        while self.nivel == "menu_0":
            ...
            if self.contador > 0:
                self.contador += 1
                print("%s para reactivar JAMDragAndDrop sobre el Calendario" %
                      (150 - self.contador))
    ...
    def reposiciona(self, drag, group):
        ...
        # self.calendario  # Lo que se dibuja y actualiza es ahora Mi grupo de Sprites.
        self.widgets = group
        self.contador = 1
